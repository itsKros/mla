    ...
    useEffect(() => {
        ...
        loadScript('https://code.jquery.com/jquery-3.6.0.min.js')
          ...
          .then(() => {
            ...
            // Lightbox open
            $('.video-carousel .item').off('click').on('click', function () {
              const videoUrl = 'https://www.youtube.com/embed/joiyb6c_Ry4?autoplay=1';
              const lightbox = $('.video-lightbox');
              const iframe = lightbox.find('iframe.lightbox-video');
            ...
            // Lightbox close
            $('.video-lightbox .close-video').off('click').on('click', function () {
              const lightbox = $(this).closest('.video-lightbox');
              const iframe = lightbox.find('iframe.lightbox-video');
            ...
            <div
                ...
                <button type="button"
                    ...
                    <div className="title">
                        ...
                        <p className="font-light text-gray-800 sm:text-lg leading-relaxed pt-2">Download pre-built,
                            high-converting templates that help you capture leads and boost course enrollments—no
                            guesswork needed.</p>
                        <div
                            className="mt-3 h-1 w-20 rounded-full transition-all duration-300 bg-gray-200 group-hover:bg-blue-200">
                        </div>
